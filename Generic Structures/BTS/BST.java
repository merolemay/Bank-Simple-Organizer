...
public class BST<E,K extends Comparable<? super K>>{
	...
	public ArrayList<E> toArrayList(){
		...
		array = toArrayListAux(root,array);
		
		return array;
		
	}
	
	public ArrayList<E> toArrayListAux(Node<E,K> node,ArrayList<E> array) {
		
	    if (node != null) {
	    	array.add(node.getElement());
	    	toArrayListAux(node.nodeLeft,array);
	    	toArrayListAux(node.nodeRight,array);
	    }  
	    return array;
	}
